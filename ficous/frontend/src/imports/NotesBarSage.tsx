import svgPaths from "./svg-xhea8ecetu";
...
function Frame401() {
  return <div className="bg-[#d9d9d9] rounded-[999px] shrink-0 size-[20px]" />;
}
...
function Frame6() {
  return (
    <div className="box-border content-stretch flex h-[41px] items-center justify-between px-[12px] py-[14px] relative rounded-[10px] w-[560px]">
      <p className="font-['Alexandria:Regular',_sans-serif] font-normal leading-[normal] relative shrink-0 text-[10px] text-[grey] w-[169px]">Pergunte alguma coisa</p>
      <Frame401 />
    </div>
  );
}
...
function Sage() {
  return (
    <div className="bg-[#e7e7e7] box-border content-stretch flex gap-[5px] items-center px-[10px] py-[5px] relative rounded-[8px] shrink-0" data-name="sage">
...
function Frame378() {
  return (
    <div className="absolute backdrop-blur-[2.5px] backdrop-filter bg-[rgba(245,245,245,0.75)] box-border content-stretch flex gap-[10px] items-center left-[738px] px-[10px] py-[9px] rounded-[13px] top-[805px]">
...
export default function NotesBarSage() {
  return (
    <div className="bg-white relative size-full" data-name="notes - bar-sage">
