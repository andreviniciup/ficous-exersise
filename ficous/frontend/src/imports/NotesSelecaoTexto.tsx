import svgPaths from "./svg-9j179wio0d";
...
function Frame6() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[10px] items-center p-[12px] relative rounded-[10px] w-[390px]">
      <p className="font-['Alexandria:Regular',_sans-serif] font-normal leading-[normal] relative shrink-0 text-[10px] text-[grey] w-[169px]">Pergunte alguma coisa ao sage</p>
    </div>
  );
}
...
function Frame380() {
  return (
    <div className="bg-neutral-100 box-border content-stretch flex gap-[10px] items-center p-[5px] relative rounded-[15px]">
      ...
      <div className="flex h-[390px] items-center justify-center relative shrink-0 w-[35.188px]">
        <div className="flex-none rotate-[270deg]">
          <Frame6 />
        </div>
      </div>
...
export default function NotesSelecaoTexto() {
  return (
    <div className="bg-white relative size-full" data-name="notes - seleção texto">
      ...
      <Frame378 />
      <Sidebar />
      <div className="absolute flex h-[45.188px] items-center justify-center left-[867px] top-[433px] w-[400px]">
        <div className="flex-none rotate-[90deg]">
          <Frame380 />
        </div>
      </div>
