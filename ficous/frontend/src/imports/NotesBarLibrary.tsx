import svgPaths from "./svg-k5n5wu79w3";
...
function Actions() {
  return (
    <div className="box-border content-stretch flex gap-[5px] items-center px-[10px] py-[5px] relative shrink-0" data-name="actions">
...
function Sage() {
  return (
    <div className="box-border content-stretch flex gap-[5px] items-center px-[10px] py-[5px] relative shrink-0" data-name="sage">
...
function Library() {
  return (
    <div className="bg-[#e7e7e7] box-border content-stretch flex gap-[5px] items-center px-[10px] py-[5px] relative rounded-[8px] shrink-0" data-name="library">
...
function Frame378() {
  return (
    <div className="absolute backdrop-blur-[2px] backdrop-filter bg-[rgba(245,245,245,0.75)] box-border content-stretch flex gap-[10px] items-center left-[738px] px-[10px] py-[9px] rounded-[13px] top-[805.39px]">
    ...
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] h-[27.13px] ml-0 mt-0 relative w-[21.189px]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 28">
          <path d={svgPaths.p14286ef0} fill="var(--fill-0, white)" id="Vector 12" />
        </svg>
      </div>
...
function Item01Fonte() {
  return (
    <div className="bg-[rgba(230,230,230,0.3)] relative rounded-[5px] shrink-0 w-full" data-name="Item01_fonte">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center p-[5px] relative w-full">
          <Group79 />
          <p className="font-['Alexandria:Regular',_sans-serif] font-normal h-[30px] leading-[27px] relative shrink-0 text-[#444444] text-[12px] w-[186px]">Introdução ao Tratamento de</p>
        </div>
      </div>
    </div>
  );
...
function Item02Fonte() {
  return (
    <div className="bg-[rgba(230,230,230,0.3)] relative rounded-[5px] shrink-0 w-full" data-name="Item02_fonte">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center p-[5px] relative w-full">
          <Group80 />
          <p className="font-['Alexandria:Regular',_sans-serif] font-normal leading-[27px] relative shrink-0 text-[#444444] text-[12px] text-nowrap whitespace-pre">Estrutura do Try-Catch-Finally</p>
        </div>
      </div>
    </div>
  );
...
function Item03Fonte() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center p-[5px] relative shrink-0" data-name="Item03_fonte">
      <Group81 />
      <p className="font-['Alexandria:Regular',_sans-serif] font-normal leading-[27px] relative shrink-0 text-[#444444] text-[12px] text-nowrap whitespace-pre">Exceções Checked e Uncheck</p>
    </div>
  );
}
...
function Frame393() {
  return (
    <div className="bg-[rgba(230,230,230,0.3)] content-stretch flex flex-col gap-[10px] items-start relative rounded-[5px] shrink-0 w-full">
      <Item03Fonte />
    </div>
  );
}
...
function Item04Fonte() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center p-[5px] relative shrink-0" data-name="Item04_fonte">
      <Group82 />
      <p className="font-['Alexandria:Regular',_sans-serif] font-normal leading-[27px] relative shrink-0 text-[#444444] text-[12px] text-nowrap whitespace-pre">{`Hierarquia das Exceções em `}</p>
    </div>
  );
}
...
function ListItemFonts() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-full" data-name="list_item_fonts">
      <Item01Fonte />
      <Item02Fonte />
      <Frame393 />
      <Frame392 />
...
function ButtonAddNewFont() {
  return (
    <div className="bg-[rgba(231,231,231,0.45)] relative rounded-[8px] shrink-0 w-full" data-name="button_add_new_font">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[10px] py-[20px] relative w-full">
          <div className="h-[15px] relative shrink-0 w-[11px]" data-name="Vector">
            <div className="absolute inset-[-5%_-6.82%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13 17">
                <path d={svgPaths.p3186fc40} id="Vector" stroke="var(--stroke-0, #ADADAD)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              </svg>
            </div>
          </div>
          <Frame23 />
...
export default function NotesBarLibrary() {
  return (
    <div className="bg-white relative size-full" data-name="notes - bar-library">
