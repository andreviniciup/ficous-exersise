import svgPaths from "./svg-e00svel11n";
...
export default function NotesBalaoResposta() {
  return (
    <div className="bg-white relative size-full" data-name="notes - balão resposta">
      <Group149 />
      <div className="absolute flex h-[216.781px] items-center justify-center left-[605px] top-[309px] w-[405px]">
        <div className="flex-none rotate-[90deg]">
          <Frame380 />
        </div>
      </div>
