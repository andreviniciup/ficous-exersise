import svgPaths from "./svg-bgb5fc7ryp";
...
function Frame6() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[10px] items-start justify-center p-[12px] relative rounded-[10px]">
      <p className="font-['Alexandria:Regular',_sans-serif] font-normal leading-[normal] relative shrink-0 text-[#313131] text-[12px] w-[349px]">Me explique essa parte, eu fiquei com duvida nessa parte. pq não consigo entender nada</p>
    </div>
  );
}
...
export default function NotesSelecaoTextoResposta() {
  return (
    <div className="bg-white relative size-full" data-name="notes - seleção texto - resposta">
      <div className="absolute flex h-[46.375px] items-center justify-center left-[524px] top-[68px] w-[449.813px]">
        <div className="flex-none rotate-[90deg]">
          <ContentCabecalho />
        </div>
      </div>
      <div className="absolute bg-[#d4e8fb] h-[20px] left-[526px] top-[353px] w-[77px]" />
      <div className="absolute bg-[#d4e8fb] h-[20px] left-[543px] top-[379px] w-[671px]" />
      <div className="absolute bg-[#d4e8fb] h-[20px] left-[543px] top-[406px] w-[600px]" />
      <div className="absolute font-['Alexandria:Regular',_sans-serif] font-normal h-[486px] leading-[0] left-[524px] text-[#202020] text-[16px] top-[133px] w-[700px]">
      ...
      <Frame378 />
      <Sidebar />
      <div className="absolute flex h-[61.188px] items-center justify-center left-[867px] top-[433px] w-[383px]">
        <div className="flex-none rotate-[90deg]">
          <Frame380 />
        </div>
      </div>
