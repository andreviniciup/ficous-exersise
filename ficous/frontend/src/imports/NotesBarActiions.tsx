import svgPaths from "./svg-60edms2m05";
...
function Actions() {
  return (
    <div className="bg-[#e7e7e7] box-border content-stretch flex gap-[5px] items-center px-[10px] py-[5px] relative rounded-[8px] shrink-0" data-name="actions">
...
function Sage() {
  return (
    <div className="box-border content-stretch flex gap-[5px] items-center px-[10px] py-[5px] relative rounded-[8px] shrink-0" data-name="sage">
...
function Library() {
  return (
    <div className="box-border content-stretch flex gap-[5px] items-center px-[10px] py-[5px] relative rounded-[8px] shrink-0" data-name="library">
...
function Frame378() {
  return (
    <div className="absolute bg-neutral-100 box-border content-stretch flex gap-[10px] items-center left-[738px] px-[10px] py-[9px] rounded-[13px] top-[805px]">
...
function Frame384() {
  return (
    <div className="content-stretch flex gap-[5px] items-center relative shrink-0">
      <div className="h-[10px] relative shrink-0 w-[9px]" data-name="Vector">
        <div className="absolute inset-[-6.25%_-6.94%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 12">
            <g id="Vector">
              <path d={svgPaths.p149e6530} stroke="var(--stroke-0, #9A9A9A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
              <path d={svgPaths.p308b9d80} stroke="var(--stroke-0, #9A9A9A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
              <path d={svgPaths.p6dbcf00} stroke="var(--stroke-0, #9A9A9A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
            </g>
          </svg>
        </div>
      </div>
      ...
      <div className="relative shrink-0 size-[10px]" data-name="Vector">
        <div className="absolute inset-[-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
            <path d={svgPaths.p1c8a3300} id="Vector" stroke="var(--stroke-0, #9A9A9A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
          </svg>
        </div>
      </div>
...
function Frame386() {
  return (
    <div className="content-stretch flex gap-[5px] items-center relative shrink-0">
      <div className="h-[10px] relative shrink-0 w-[14px]" data-name="Vector">
        <div className="absolute inset-[-6.25%_-4.46%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 12">
            <path d={svgPaths.p611edc0} id="Vector" stroke="var(--stroke-0, #9A9A9A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.25" />
          </svg>
        </div>
      </div>
...
export default function NotesBarActiions() {
  return (
    <div className="bg-white relative size-full" data-name="notes - bar-actiions">
