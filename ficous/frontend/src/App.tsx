...
function ButtonSidebarPesquisa() {
  return (
    <div className="bg-[#ededed] box-border content-stretch flex gap-[10px] items-center px-[10px] py-[5px] relative rounded-[5px] shrink-0 w-[200px] cursor-pointer hover:bg-[#e0e0e0] transition-colors" data-name="button-sidebar-pesquisa">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="button-sidebar-paginaInicial">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center px-[10px] py-[5px] relative w-full cursor-pointer hover:bg-gray-50 rounded transition-colors">
          <div className="relative shrink-0 size-[14px]" data-name="Vector">
...
function ButtonSidebarDisciplinasAdd() {
  return (
    <div className="box-border content-stretch flex gap-[93px] items-center px-[10px] py-[5px] relative shrink-0 w-[200px] cursor-pointer hover:bg-gray-50 rounded transition-colors" data-name="button-sidebar-disciplinas-add">
...
function ButtonSidebarDisciplinas01() {
  return (
    <div className="relative shrink-0 w-full" data-name="button-sidebar-disciplinas-01">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[5px] items-center px-[10px] py-[5px] relative w-full cursor-pointer hover:bg-gray-50 rounded transition-colors">
...
function ButtonSidebarTrabalhos() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center px-[10px] py-[5px] relative shrink-0 w-[200px] cursor-pointer hover:bg-gray-50 rounded transition-colors" data-name="button-sidebar-trabalhos">
...
function ButtonSidebarNotas() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center px-[10px] py-[5px] relative shrink-0 w-[200px] cursor-pointer hover:bg-gray-50 rounded transition-colors" data-name="button-sidebar-notas">
...
function ButtonSidebarFaltas() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center px-[10px] py-[5px] relative shrink-0 w-[200px] cursor-pointer hover:bg-gray-50 rounded transition-colors" data-name="button-sidebar-faltas">
      <div className="h-[13px] relative shrink-0 w-[16px]" data-name="Vector">
        <div className="absolute inset-[-7.69%_-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 15">
            <path d={svgPaths.p2d7e100} id="Vector" stroke="var(--stroke-0, #585858)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
...
function ButtonSidebarFoco() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center px-[10px] py-[5px] relative shrink-0 w-[200px] cursor-pointer hover:bg-gray-50 rounded transition-colors" data-name="button-sidebar-foco">
      <div className="relative shrink-0 size-[14px]" data-name="Vector">
        <div className="absolute inset-[-7.143%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
...
function ButtonSidebarDesempenho() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center px-[10px] py-[5px] relative shrink-0 w-[200px] cursor-pointer hover:bg-gray-50 rounded transition-colors" data-name="button-sidebar-desempenho">
      <div className="h-[13px] relative shrink-0 w-[16px]" data-name="Vector">
        <div className="absolute inset-[-7.69%_-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 15">
            <path d={svgPaths.p2d7e100} id="Vector" stroke="var(--stroke-0, #585858)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
...
function ButtonSidebarConfiguaracoes() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-center px-[10px] py-[5px] relative shrink-0 w-[200px] cursor-pointer hover:bg-gray-50 rounded transition-colors" data-name="button-sidebar-configuarações">
      <div className="relative shrink-0 size-[14px]" data-name="Vector">
        <div className="absolute inset-[-6.25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
            <g id="Vector">
